...
public final class DbConnectionPool {
    ...
    private BlockingDeque<ProxyConnection> forCheckingDeque =
            new LinkedBlockingDeque<>(ConnectionFactory.MAX_CONNECTIONS);
    ...
    private void fillConnectionsIntoPool() {
        ...
        for (int i = (freeDeque.size() + busyDeque.size()); i < ConnectionFactory.MAX_CONNECTIONS; i++) {
            try {
                ...
                logger.log(Level.DEBUG, "connection created. freeDeque size = {}, busy deQue = {}",
                        freeDeque.size(), busyDeque.size());
