...
class ConnectionFactory {//ограничить доступ извне
    ...
    static {
        ...
        TIMER_SERVICE_INTERVAL = Integer.parseInt(properties.getProperty("timer_service_interval",
                "1000"));
    ...
    private static void loadPropertyFromFile() {
        try (FileInputStream fileInputStream = new FileInputStream(PROPERTIES_FILE)) {
            ...
            logger.log(Level.FATAL, "ConnectionFactory loadPropertyFromFile file - {} - can't be read",
                    FILE_NAME);
