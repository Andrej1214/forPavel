...
public class ProductServiceImpl implements ProductService {
    ...
    @Override
    public Map<Product, String> findProductsByParam(Map<String, String> searchParamMap, Map<String,
            String> orderByParamQuery) throws ServiceException {
        ParameterValidator parameterValidator = ParameterValidatorImpl.getInstance();
        ...
        try {
            ...
            totalProductsFound = productDao.countBySearchParam(brandId, typeId, minPrice, maxPrice, minPower,
                    maxPower, searchWord, inStock);
            ...
            productQuantityMap = productDao.findBySearchParam(brandId, typeId, minPrice, maxPrice, minPower,
                    maxPower, searchFrom, searchNextNumberOfProducts, searchWord, orderQuery, inStock);
        } catch (DaoException e) {
    ...
    @Override
    public boolean findMapProductQuantityById(Map<String, String> inputProductIdQuantity, Map<Product,
        ...
        try {
            ...
            AttributeValidator attributeValidator = AttributeValidatorImpl.getInstance();
            if (!attributeValidator.isInt5Valid(id)) {
                logger.log(Level.ERROR, "ProductService error while findMapProductQuantityById incorrect id :{}",
                        id);
            ...
            if (productQuantityMap.isEmpty()) {
                ...
                throw new ServiceException("ProductService findMapProductQuantityById Product was not found by id :"
                        + id);
            }
            return true;
        } catch (DaoException e) {
            logger.log(Level.ERROR, "ProductService exception while findMapProductQuantityById. {}",
                    e.getMessage());
            throw new ServiceException(e);
        }
    }
