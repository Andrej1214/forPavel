...
public class ValidatorPattern {
    ...
    private final String emailPattern = "^(?![_.-])((?![_.-][_.-])[a-zA-Z\\d_.-]){0,63}[a-zA-Z\\d]@((?!-)((?!--)" +
            "[a-zA-Z\\d-]){0,63}[a-zA-Z\\d]\\.){1,2}([a-zA-Z]{2,14}\\.)?[a-zA-Z]{2,14}$";
    ...
    public String getInteger3StringPattern() {
        return integer3StringPattern;
    }
