...
public class User extends AbstractEntity {
    ...
    public User(int id, String firstName, String lastName, String login, String email, String phone,
                AccessLevel accessLevel, Instant date, BigDecimal amount) {
        this.id = id;
    ...
    public User(String firstName, String lastName, String login, String email, String phone,
                AccessLevel accessLevel, Instant date, BigDecimal amount) {
        this.firstName = firstName;
        this.lastName = lastName;
        this.login = login;
