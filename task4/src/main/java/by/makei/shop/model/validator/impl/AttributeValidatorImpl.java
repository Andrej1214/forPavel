...
public class AttributeValidatorImpl implements AttributeValidator {
    ...
    public boolean isPageButtonValid(String pageButton) {
        return (pageButton != null && (pageButton.matches(NEXT_PAGE) || pageButton.matches(PREVIOUS_PAGE)
                || pageButton.matches(SEARCH_PAGE)));
    }
    ...
    public boolean isDetailValid(String detail) {
        return (detail == null || detail.equals(EMPTY_STRING)
                || detail.matches(validatorPattern.getDescriptionPattern()));
    }
