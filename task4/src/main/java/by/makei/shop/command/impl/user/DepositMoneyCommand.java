...
public class DepositMoneyCommand implements Command {
    ...
    public Router execute(HttpServletRequest request) throws CommandException {
        ...
        try {
            ...
            if (!userService.updateUserMoneyAmount(currentUserId, currentUserAmount,
                    depositDataMap.get(AttributeName.AMOUNT_TO_DEPOSIT))) {
            ...
            if (optionalUser.isPresent()) {
                ...
                router.setCurrentPage(GO_TO_MAIN + RedirectMessage.REDIRECT_MESSAGE
                        + RedirectMessage.USER_MONEY_AMOUNT_UPDATED);
            } else {
