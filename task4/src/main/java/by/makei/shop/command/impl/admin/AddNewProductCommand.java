...
public class AddNewProductCommand implements Command {
    ...
    public Router execute(HttpServletRequest request) throws CommandException {
        ...
        try (
            ...
            logger.log(Level.ERROR, "error while addNewProductCommand is trying to get photo. {}",
                    e.getMessage());
        ...
        try {
            if (productService.addNewProduct(productDataMap, bytesPhoto)) {
                ...
                router.setCurrentPage(PagePath.GO_TO_ADD_NEW_PRODUCT + RedirectMessage.REDIRECT_MESSAGE
                        + RedirectMessage.SUCCESSFULLY_ADDED);
            } else {
