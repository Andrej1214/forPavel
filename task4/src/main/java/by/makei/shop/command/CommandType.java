...
public enum CommandType {
    ...
    CHANGE_LANGUAGE(new ChangeLanguageCommand(), EnumSet.of(AccessLevel.ADMIN, AccessLevel.GUEST,
            AccessLevel.USER, AccessLevel.BLOCKED)),
    ...
    DEFAULT(new DefaultCommand(), EnumSet.of(AccessLevel.ADMIN, AccessLevel.GUEST, AccessLevel.USER,
            AccessLevel.BLOCKED)),
    ...
    GO_TO_ABOUT(new GoToAboutCommand(), EnumSet.of(AccessLevel.ADMIN, AccessLevel.USER, AccessLevel.GUEST,
            AccessLevel.BLOCKED)),
    ...
    GO_TO_MAIN(new GoToMainCommand(), EnumSet.of(AccessLevel.ADMIN, AccessLevel.GUEST, AccessLevel.USER,
            AccessLevel.BLOCKED)),
